          ...
          responseSchema: {
            ...
            properties: {
              skinAnalysis: {
                ...
                required: ["hydration", "rednessLevels", "notes", "texture", "pores", "elasticity"]
              },
              skinType: {
                type: Type.OBJECT,
                properties: {
